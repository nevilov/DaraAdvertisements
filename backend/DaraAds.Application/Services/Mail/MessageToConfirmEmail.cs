...
+ $"Если по какой-то причине произошла ошибка, вышлите себе токен подтверждения еще раз, нажав <a href=\"{uri}api/user/send/confirmEmailToken?userId={id}&email={email}\" class=\"btn\">сюда</a>";
